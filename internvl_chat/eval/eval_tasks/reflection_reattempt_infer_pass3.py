    ...
    for item in all_data:
        ...
        try:
            for repeat_i in range(3):
                result = item[f'pred_response_round{current_round}_re{repeat_i}']
...
def main():
    ...
    result_filename = f"round{args.inference_round}_pass3_" + result_filename
    ...
    for idx in tqdm(sampler):
        ...
        for repeat_i in range(3):
            ...
            pred_data[f'pred_response_round{args.inference_round}_re{repeat_i}'] = response
